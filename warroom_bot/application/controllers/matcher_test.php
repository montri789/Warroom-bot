...
class Matcher_test extends CI_Controller{
	...
	public function bot_auto($client_id=null,$to_date = null){
		...
		if($to_date == null){
			...
			//$to_date = date('Y-m-d H:i:s',strtotime("-1 hours",$date_now));
			//$to_date = date('Y-m-d H:i:s',strtotime("-25 minutes",$date_now));

			$to_date = date('Y-m-d H:i:s',strtotime("-2 hours"));
			//$to_date = $date_now;
		}
	...
	public function clear_all()
	{
		...
		$this->db->update('subject', $data, "bot_id = -1");
