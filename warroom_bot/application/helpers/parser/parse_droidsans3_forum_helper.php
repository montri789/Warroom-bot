<?php
	function parse_droidsans3_forum($fetch,$page,$debug=false)
	{
		$log_unit_name = 'parse_droidsans3_forum';
		...
		else
		{
			if($parsed_posts_count == 0 && $page->sub_comment == 0) 
			{
				...
				$main_content = $html->find('div[class=caption]',0);					
			...
			foreach($comments as $k=>$c)
			{
				...
				if($i < $parsed_posts_count-1)
				{
					...
					$c_title = $c->find('span[class=post-num] a',0);
